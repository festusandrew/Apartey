import svgPaths from "./svg-za1azrrc5z";
...
function Heading() {
  return (
    <div className="h-[57.372px] relative shrink-0 w-full" data-name="Heading 1">
      <p className="absolute font-['Montserrat:Bold',sans-serif] font-bold leading-[57.372px] left-0 text-[#10182c] text-[38.248px] top-[-0.91px] tracking-[-0.9562px] whitespace-nowrap">Enquiries</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[28.686px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Mulish:Regular',sans-serif] font-normal leading-[28.686px] left-0 text-[#6a7282] text-[19.124px] top-[-0.91px] whitespace-nowrap">Manage your leads and convert them faster.</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="h-[91.523px] relative shrink-0 w-[388.999px]" data-name="Container">
...
function TextInput() {
  return (
    <div className="absolute bg-white h-[50.315px] left-[-0.17px] rounded-[19.124px] top-0 w-[341.502px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip pl-[49.176px] pr-[21.856px] py-[10.928px] relative rounded-[inherit] size-full">
        <p className="font-['Mulish:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[17.758px] text-[rgba(10,10,10,0.5)] whitespace-nowrap">Search enquiries...</p>
      </div>
...
function Icon() {
  return (
    <div className="absolute left-[16.39px] size-[21.856px] top-[14.23px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.8561 21.8561">
        <g id="Icon">
          <path d={svgPaths.p2304af00} id="Vector" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.82134" />
          <path d={svgPaths.p3aa5df60} id="Vector_2" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.82134" />
        </g>
      </svg>
    </div>
  );
...
function Container4() {
  return (
    <div className="absolute h-[50.315px] left-0 top-0 w-[341.502px]" data-name="Container">
      <TextInput />
      <Icon />
    </div>
  );
...
function Container3() {
  return (
    <div className="h-[50.315px] relative shrink-0 w-[341.502px]" data-name="Container">
...
function Container1() {
  return (
    <div className="h-[91.523px] relative shrink-0 w-[1284.958px]" data-name="Container">
...
function Frame10() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full whitespace-nowrap">
      <p className="font-['Mulish:Bold',sans-serif] font-bold leading-[23.905px] relative shrink-0 text-[#10182c] text-[19.124px]">Nnaemeka Okechukwu</p>
      <p className="font-['Mulish:Italic',sans-serif] font-normal italic leading-[24.588px] relative shrink-0 text-[#6a7282] text-[16.392px]">10m ago</p>
    </div>
  );
}
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[16.392px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.3921 16.3921">
        <g id="Icon">
          <path d={svgPaths.p2e45c700} id="Vector" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.36601" />
          <path d={svgPaths.p31d8e600} id="Vector_2" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.36601" />
          <path d="M5.46449 4.09609H5.47132" id="Vector_3" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.36601" />
          <path d="M10.9285 4.09609H10.9354" id="Vector_4" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.36601" />
          <path d="M8.19651 4.09609H8.20334" id="Vector_5" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.36601" />
          <path d="M8.19651 6.82811H8.20334" id="Vector_6" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.36601" />
          <path d="M8.19651 9.56012H8.20334" id="Vector_7" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.36601" />
          <path d="M10.9285 6.82811H10.9354" id="Vector_8" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.36601" />
          <path d="M10.9285 9.56012H10.9354" id="Vector_9" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.36601" />
          <path d="M5.46449 6.82811H5.47132" id="Vector_10" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.36601" />
          <path d="M5.46449 9.56012H5.47132" id="Vector_11" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.36601" />
        </g>
      </svg>
    </div>
  );
...
function Frame8() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <Icon1 />
      <p className="font-['Mulish:Bold',sans-serif] font-bold leading-[28.686px] relative shrink-0 text-[#1e1e1e] text-[19.124px] whitespace-nowrap">{` 2 Pankshin Road`}</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <Frame8 />
      <p className="font-['Mulish:Regular',sans-serif] font-normal leading-[28.686px] min-w-full relative shrink-0 text-[#6a7282] text-[19.124px] w-[min-content]">Hi, i’d Iike to book a viewing this weekend...</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex items-center justify-center px-[20px] py-[8px] relative rounded-[12px] shrink-0">
      ...
      <p className="font-['Mulish:Bold',sans-serif] font-bold leading-[28.686px] relative shrink-0 text-[19.124px] text-black whitespace-nowrap">RepIy</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex items-center justify-center px-[20px] py-[8px] relative rounded-[12px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.2)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['Mulish:Bold',sans-serif] font-bold leading-[28.686px] relative shrink-0 text-[19.124px] text-black whitespace-nowrap">Assign</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-col gap-[15px] items-start relative shrink-0 w-[481px]">
      <Frame11 />
      <Frame7 />
    </div>
  );
...
function Frame() {
  return (
    <div className="relative shrink-0 w-full">
      ...
      <div className="content-stretch flex gap-[15px] items-start px-[45px] py-[16px] relative size-full">
        <div className="relative shrink-0 size-[24px]">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
            <circle cx="12" cy="12" fill="var(--fill-0, #C85212)" id="Ellipse 132" r="12" />
          </svg>
        </div>
        <Frame12 />
      </div>
...
function Frame13() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col items-start left-1/2 top-[113px] w-[610px]">
      <Frame />
      <Frame1 />
      <Frame2 />
    </div>
...
function Frame3() {
  return (
    <div className="bg-white h-[767px] overflow-clip relative rounded-[20px] shrink-0 w-[610px]">
      <p className="absolute font-['Mulish:Bold',sans-serif] font-bold leading-[28.686px] left-[46px] text-[#10182c] text-[22px] top-[42px] whitespace-nowrap">Incoming Enquiries</p>
      <Frame13 />
    </div>
  );
}
...
function Cell() {
  return (
    <div className="content-stretch flex flex-col items-start px-[43.2px] py-[21.6px] relative shrink-0 w-[136px]" data-name="Cell">
      <div className="flex flex-col font-['Manrope:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#43474e] text-[13.5px] tracking-[1.35px] uppercase whitespace-nowrap">
        <p className="leading-[normal]">Renter</p>
      </div>
    </div>
  );
}
...
function Cell1() {
  return (
    <div className="content-stretch flex flex-col items-start px-[32.4px] py-[21.6px] relative shrink-0 w-[152px]" data-name="Cell">
      <div className="flex flex-col font-['Manrope:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#43474e] text-[13.5px] tracking-[1.35px] uppercase whitespace-nowrap">
        <p className="leading-[normal]">Property</p>
      </div>
    </div>
  );
}
...
function Cell2() {
  return (
    <div className="content-stretch flex flex-col items-start pl-[18px] pr-[32.4px] py-[21.6px] relative shrink-0 w-[136px]" data-name="Cell">
      <div className="flex flex-col font-['Manrope:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#43474e] text-[13.5px] tracking-[1.35px] uppercase whitespace-nowrap">
...
function Cell3() {
  return (
    <div className="content-stretch flex flex-col items-start px-[32.4px] py-[21.6px] relative shrink-0 w-[172px]" data-name="Cell">
      <div className="flex flex-col font-['Manrope:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#43474e] text-[13.5px] tracking-[1.35px] uppercase whitespace-nowrap">
        <p className="leading-[normal]">Broker</p>
      </div>
    </div>
  );
}
...
function HeaderRow() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center relative shrink-0 w-[607px]" data-name="Header → Row">
      <Cell />
      <Cell1 />
      <Cell2 />
      <Cell3 />
...
function Cell4() {
  return (
    <div className="content-stretch flex flex-col items-start px-[43.2px] py-[21.6px] relative shrink-0 w-[136px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#545f72] text-[16.2px] whitespace-nowrap">
        <p className="leading-[21.6px]">Peter Akin</p>
      </div>
    </div>
  );
}
...
function Cell5() {
  return (
    <div className="content-stretch flex flex-col items-start px-[32.4px] py-[21.6px] relative shrink-0 w-[152px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#545f72] text-[16.2px] whitespace-nowrap">
        <p className="leading-[21.6px]">Sunset Villa</p>
      </div>
    </div>
  );
}
...
function DownLine() {
  return (
    <div className="overflow-clip relative shrink-0 size-[24px]" data-name="down_line">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Group">
          <g id="Vector" />
          <path clipRule="evenodd" d={svgPaths.p15cf7600} fill="var(--fill-0, #0088FF)" fillRule="evenodd" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Background() {
  return (
    <div className="bg-[rgba(0,136,255,0.1)] content-stretch flex gap-[8px] items-center px-[10.8px] py-[2.7px] relative rounded-[16.2px] shrink-0" data-name="Background">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#08f] text-[13.5px] whitespace-nowrap">
...
function Cell6() {
  return (
    <div className="content-stretch flex flex-col items-start px-[18px] py-[21.6px] relative shrink-0 w-[137px]" data-name="Cell">
      <Background />
    </div>
  );
}
...
function Cell7() {
  return (
    <div className="content-stretch flex flex-col items-start px-[32.4px] py-[21.6px] relative shrink-0 w-[172px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[16.2px] text-[blue] whitespace-nowrap">
        <p className="leading-[21.6px]">Tunde John</p>
      </div>
    </div>
  );
}
...
function HeaderRow1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[607px]" data-name="Header → Row">
      <div aria-hidden="true" className="absolute border border-[#ebeef0] border-solid inset-0 pointer-events-none" />
      <Cell4 />
      <Cell5 />
      <Cell6 />
      <Cell7 />
...
function Cell8() {
  return (
    <div className="content-stretch flex flex-col items-start px-[43.2px] py-[21.6px] relative shrink-0 w-[136px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#545f72] text-[16.2px] whitespace-nowrap">
        <p className="leading-[21.6px]">Maya Lin</p>
      </div>
    </div>
  );
}
...
function Cell9() {
  return (
    <div className="content-stretch flex flex-col items-start px-[32.4px] py-[21.6px] relative shrink-0 w-[152px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#545f72] text-[16.2px] w-[120px]">
        <p className="leading-[21.6px]">Oceanview Retreat</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="overflow-clip relative shrink-0 size-[24px]" data-name="down_line">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Group">
          <g id="Vector" />
          <path clipRule="evenodd" d={svgPaths.p15cf7600} fill="var(--fill-0, #F76D30)" fillRule="evenodd" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Background1() {
  return (
    <div className="bg-[rgba(247,109,48,0.1)] content-stretch flex gap-[8px] items-center px-[10.8px] py-[2.7px] relative rounded-[16.2px] shrink-0" data-name="Background">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#f76d30] text-[13.5px] whitespace-nowrap">
        <p className="leading-[normal]">Offer Made</p>
      </div>
      <DownLine1 />
    </div>
  );
...
function Cell11() {
  return (
    <div className="content-stretch flex flex-col items-start px-[32.4px] py-[21.6px] relative shrink-0 w-[172px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[16.2px] text-[blue] whitespace-nowrap">
        <p className="leading-[21.6px]">Sarah Kahn</p>
      </div>
    </div>
  );
}
...
function Cell12() {
  return (
    <div className="content-stretch flex flex-col items-start px-[43.2px] py-[21.6px] relative shrink-0 w-[136px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#545f72] text-[16.2px] whitespace-nowrap">
        <p className="leading-[21.6px]">Liam Chen</p>
      </div>
    </div>
  );
}
...
function Cell13() {
  return (
    <div className="content-stretch flex flex-col items-start px-[32.4px] py-[21.6px] relative shrink-0 w-[152px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#545f72] text-[16.2px] whitespace-nowrap">
        <p className="leading-[21.6px]">Mountain Lodge</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="overflow-clip relative shrink-0 size-[24px]" data-name="down_line">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Group">
          <g id="Vector" />
          <path clipRule="evenodd" d={svgPaths.p15cf7600} fill="var(--fill-0, #737678)" fillRule="evenodd" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Background2() {
  return (
    <div className="bg-[rgba(115,118,120,0.1)] content-stretch flex gap-[8px] items-center px-[10.8px] py-[2.7px] relative rounded-[16.2px] shrink-0" data-name="Background">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#737678] text-[13.5px] whitespace-nowrap">
...
function Cell15() {
  return (
    <div className="content-stretch flex flex-col items-start px-[32.4px] py-[21.6px] relative shrink-0 w-[172px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[16.2px] text-[blue] whitespace-nowrap">
        <p className="leading-[21.6px]">Raj Patel</p>
      </div>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 overflow-clip top-[113px] w-[607px]" data-name="Container">
      <Table />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="bg-white h-[767px] overflow-clip relative rounded-[20px] shrink-0 w-[610px]">
      <p className="absolute font-['Mulish:Bold',sans-serif] font-bold leading-[28.686px] left-[46px] text-[#10182c] text-[22px] top-[42px] whitespace-nowrap">Lead Tracker</p>
      <Container5 />
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="relative shrink-0">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[40px] items-start justify-center relative size-full">
        <Frame3 />
        <Frame4 />
      </div>
    </div>
...
function Container() {
  return (
    <div className="content-stretch flex flex-col gap-[32.784px] h-[987px] items-start relative shrink-0 w-full" data-name="Container">
      <Container1 />
      <Frame14 />
    </div>
  );
...
function MainContent() {
  return (
    <div className="absolute content-stretch flex flex-col h-[1031px] items-start left-0 overflow-clip pt-[43.712px] px-[43.712px] top-[109px] w-[1372px]" data-name="Main Content">
      <Container />
    </div>
  );
}
...
function Text2() {
  return (
    <div className="h-[27.32px] relative shrink-0 w-[83.739px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute capitalize font-['Mulish:Bold',sans-serif] font-bold leading-[27.32px] left-0 text-[#10182c] text-[19.124px] top-[0.45px] whitespace-nowrap">enquiries</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="h-[27.32px] relative shrink-0 w-[210.436px]" data-name="Container">
...
function Button() {
  return (
    <div className="absolute left-[365.01px] rounded-[30557050px] size-[49.176px] top-[2.73px]" data-name="Button">
      <Icon4 />
      <Text3 />
    </div>
  );
...
function AgentProfilePage() {
  return (
    <div className="absolute h-[1140px] left-[355px] overflow-clip top-0 w-[1373px]" data-name="AgentProfilePage">
      <MainContent />
      <Header />
    </div>
  );
      ...
      <div className="absolute inset-[8.33%_16.66%_8.34%_16.67%]" data-name="Vector">
        <div className="absolute inset-[-5%_-6.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.4411 22.5391">
            <path d={svgPaths.p177b6bc0} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.7" strokeWidth="2.04901" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[8.34%] left-[37.51%] right-[37.49%] top-3/4" data-name="Vector">
        <div className="absolute inset-[-25%_-16.67%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.19605 6.14704">
            <path d={svgPaths.p35e2f640} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.7" strokeWidth="2.04901" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-3/4 left-[33.34%] right-[66.62%] top-1/4" data-name="Vector">
        <div className="absolute inset-[-1.02px_-9999.77%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2.05926 2.04901">
            <path d="M1.02451 1.02451H1.03475" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.7" strokeWidth="2.04901" />
          </svg>
        </div>
      </div>
      ...
      <div className="absolute inset-[12.5%_12.49%_12.5%_12.51%]" data-name="Vector">
        <div className="absolute inset-[-5.56%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.4901 20.4901">
            <path d={svgPaths.p88d4c00} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.04901" />
          </svg>
        </div>
      </div>
    </div>
...
function Text7() {
  return (
    <div className="h-[28.686px] relative shrink-0 w-[80.908px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Mulish:Regular',sans-serif] font-normal leading-[28.686px] left-[40.5px] text-[19.124px] text-center text-white top-[-0.91px] whitespace-nowrap">Enquiries</p>
      </div>
    </div>
  );
}
...
function Text8() {
  return (
    <div className="bg-[#10182c] h-[28.003px] relative rounded-[30557050px] shrink-0 w-[39.899px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Navigation() {
  return (
    <div className="h-[765px] relative shrink-0 w-[355px]" data-name="Navigation">
...
function J() {
  return (
    <div className="absolute bg-[#10182c] content-stretch flex flex-col h-[1121px] items-start left-0 top-0 w-[355px]" data-name="j9">
      <Container9 />
      <Navigation />
      <Container26 />
      <Container31 />
...
function Ai() {
  return (
    <div className="absolute bg-[#f5f6f8] h-[1140px] left-0 top-0 w-[1728px]" data-name="ai">
      <AgentProfilePage />
      <J />
    </div>
  );
